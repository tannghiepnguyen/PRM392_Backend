...
{
    /// <inheritdoc />
    public partial class AddNewTableStore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Stores",
                columns: new[] { "ID", "Address", "IsActive", "StoreName" },
                values: new object[,]
                {
                    { new Guid("036975aa-0bae-455a-a559-d0c914a43b27"), "99 Fiesta Ln, District 7, Ho Chi Minh City", true, "Crispy Corner" },
                    { new Guid("0edc6c88-6d86-42e7-9e1c-ff5821f8e366"), "78 Elm St, District 3, Ho Chi Minh City", true, "Cool Refreshments" },
                    { new Guid("275dd30a-7b06-465a-9731-e0b75f2b4441"), "45 Sakura Ave, District 2, Ho Chi Minh City", true, "Pizza Paradise" },
                    { new Guid("b1658d47-bc38-4690-9035-85c2e2d85d7c"), "12 Greenway Dr, District 5, Ho Chi Minh City", true, "Sweet Indulgence" },
                    { new Guid("deb70b97-b1fc-48f6-860c-fe9c15bcc4c7"), "123 Main St, District 1, Ho Chi Minh City", true, "Burger Haven" }
                });
